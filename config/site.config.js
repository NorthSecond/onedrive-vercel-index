...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Yifei-Yang@2r2cl2.onmicrosoft.com',
  ...
  protectedRoutes: ['/need-passwd', '/🥟 Some test files/Protected route'],
